...
$query = "SELECT * FROM administrators WHERE id=" . $_GET['id'];
$result = mysqli_query($connection, $query);

$administrator = mysqli_fetch_assoc($result);


$permission = explode(',', $administrator['permission']);
  ...
  <body>
    ...
    <form action="update.php" method="POST" class="needs-validation" novalidate>
        <div class="row">
            ...
            <input type="text" class="form-control required" name="username" id="username" value="<?php echo $administrator['username']; ?>" placeholder="Enter your Username" required>
          </div>
          <div>
            <label for="email" class="form-label">Email *</label>
            <input type="email" class="form-control required" name="email" id="email" value="<?php echo $administrator['email']; ?>"  placeholder="Enter your Email" required>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="password" class="form-control required" name="password" id="password" value="<?php echo $administrator['password']; ?>" required>
          </div>
