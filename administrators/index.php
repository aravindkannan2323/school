  ...
  <body>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><?php echo $administrator['permission']; ?></td>
            <td>
        <a href="edit.php?id=<?php echo $administrator['id']; ?>" class="btn btn-success">Edit</a>
        <a href="delete.php?id=<?php echo $administrator['id']; ?>" class="btn btn-danger">Delete</a>
        </td>
        </tr>
        <?php
        } 
