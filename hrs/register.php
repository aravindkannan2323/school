      ...
      <div class="row">
        <div class='col-md-6'>
          ...
          <div>
              ...
              <input class="form-check-input" type="checkbox" value="Add" name="permission[]" id="permissadd">
              <label class="form-check-label" for="permissadd">
                Add
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="Edit" name="permission[]" id="permissedit">
              <label class="form-check-label" for="permissedit">
                Edit
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="List" name="permission[]" id="permisslist">
              <label class="form-check-label" for="permisslist">
               List
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="Delete" name="permission[]" id="permissdelete">
